...
public class Media {
	...
	/**
	 * Tests equality of media items based on their identifying information of
	 * the item. Specifically on the media items creator, name, duration, and
	 * genre.
	 * 
	 * @param mObj
