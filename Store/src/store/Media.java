...
/**
 * A data class representing a media object with appropriate getters and
 * setters.
 * 
...
public class Media {
   ...
   * 
   * @param creator
   *          String name of the creator of this media object
   * @param name
   *          String name of the media object
   * @param duration
   ...
   *          Price in dollars
   * @param numRating
   *          Integer number of ratings given to the media object
   * @param avgRating
   *          Average rating of the media object, represented as a double
   * @param id
   ...
   * 
   * @param creator
   *          String new name of the creator
   */
   ...
   * 
   * @param duration
   *          Integer new duration of the media object
   */
   ...
   * 
   * @param genre
   *          String new name of this's genre
   */
  ...
  public int getNumSold() {
    ...
    Integer[] conArr = { (Integer) this.id }; // Selecting number of sold of
    // this media item, by id
    int numSold;
   ...
   * 
   * @param numRating
   *          Integer new number of ratings given.
   */
   ...
   * 
   * @param avgRating
   *          The new average rating as a double
   */
  ...
  /**
   * Tests equality of media items based on their identifying information of the
   * item. Specifically on the media items creator, name, duration, and genre.
   * 
   * @param mObj
   *          Media object to test equality against
  ...
  /**
   * Gives a string representation of this media object by printing all of its
   * data.
   * 
  ...
  public String toString() {
    return "Media [creator=" + creator + ", name=" + name + ", duration="
        ...
        + ", price=" + price + ", numRating=" + numRating + ", avgRating="
        + avgRating + "]";
  }
}
